        ...
        */
        ...
        for (int i = 0; i <= k; i++) {
            ...
            for (auto& flight : flights) {
                if (total_price[ flight[0] ] != INT_MAX ) { //flight[0]: from. this city is not reachable.
                    temp[ flight[1] ] = min( temp[ flight[1] ], total_price[ flight[0] ] + flight[2] ); //to. update flight[1] price.
                }
            }
